...
Segment::Segment(const Point& p1, const Point& p2, const int& traj_id, const int& seg_id):
    s(p1), e(p2), traj_id(traj_id), seg_id(seg_id), cluster_id(-1) {}
...
int const Segment::getSegmentId() {
    return this->seg_id;
}